		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comwiprogetdsreskin-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comwiprogetdsreskin-display": {
								"semanticObject": "comwiprogetdsreskin",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.wipro.getdsreskin",
									"url": sap.ui.require.toUrl("com/wipro/getdsreskin")
								}
							}
						}
					}
